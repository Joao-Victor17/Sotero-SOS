		...
		<div className="card">
			...
			<div className="filtros">
				<div className="grupo-botoes">
					...
					<button
						className={
							filtro === "atrasado" ? "ativa pulsando" : ""
						}
			...
			{dadosFiltrados.length > 0 ? (
				<div className="cards-grid">
					{dadosFiltrados.map((i) => {
						const previstoMs = tempoPrevistoMs(
							i.tempo_previsto_str
						);
						const excedeuPrevisto =
							(i.tempo_decorrido_ms ?? 0) > previstoMs &&
							previstoMs > 0;

						return (
							<div
								key={i.nr_atendimento}
								className="card cartao-sos"
							>
								<div
									className="topo"
									style={{
